...
const typeLabels: Record<string, string> = { sale: 'Venta POS', sale_cancel: 'Cancelación de venta', sale_return: 'Devolución de venta', stock_entry: 'Entrada de stock', manual_adjustment: 'Ajuste manual', service_usage: 'Uso en reparación', service_usage_void: 'Anulación de uso en reparación', purchase_receipt: 'Recepción de compra', layaway_reserve: 'Reserva por apartado', layaway_release: 'Liberación de apartado' };
const refTypeLabels: Record<string, string> = { sale: 'Venta', sale_return: 'Devolución', layaway: 'Apartado', product: 'Producto', repair: 'Reparación', manual: 'Manual', purchase: 'Compra' };
