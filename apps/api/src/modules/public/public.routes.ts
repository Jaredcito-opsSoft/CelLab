...
publicRouter.get('/', (_request, response) => {
  response.json({ business: 'LocalPOS', services: ['Diagnóstico', 'Reparación celular', 'Accesorios'], warranty: 'La vigencia depende del servicio realizado y se indica en la nota de entrega.' });
});
